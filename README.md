...
* VirtualBox에서 Guest OS를 attacker로 사용할 때 sender로부터의 spoofeed IP packet이 보이지 않은 경우 [https://gilgil.gitlab.io/2021/09/29/1.html](https://gilgil.gitlab.io/2021/09/29/1.html) 문서를 참고할 것.
